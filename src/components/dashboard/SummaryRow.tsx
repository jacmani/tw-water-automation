    ...
    <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-4">
      ...
      <div className="grid grid-cols-3 gap-3 text-center">
        <div>
          ...
          <p className="text-slate-900 dark:text-white font-semibold text-sm">{formatLitresFull(inputTotal)}</p>
        </div>
        <div>
          <p className="text-slate-500 dark:text-slate-400 text-xs mb-1">Tower Usage</p>
          <p className="text-slate-900 dark:text-white font-semibold text-sm">{formatLitresFull(towerUsage)}</p>
        </div>
        <div>
          <p className="text-slate-500 dark:text-slate-400 text-xs mb-1">Diff</p>
          <p className={`font-semibold text-sm ${diffIsLarge ? 'text-red-500 dark:text-red-400' : 'text-emerald-600 dark:text-emerald-400'}`}>
